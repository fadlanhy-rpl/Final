...
$report = query("SELECT reports.*, users.fullname as user_name FROM reports
                    ...
                    <div class="bg-white shadow-lg rounded-lg md:mx-auto my-4 max-w-2xl">
                        <div class="px-12 py-6 ">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="bg-[#243757] hover:bg-[#0b1d45] px-6 py-2 mt-4 text-white rounded ">Submit</button>
                            </div>
                        </div>
