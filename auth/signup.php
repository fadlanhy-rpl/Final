...
$users = query("SELECT users.id, users.fullname, users.username, users.email, users.role_id, roles.name as role_name
    FROM users 
        ...
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
            ...
            <main
                ...
                <div class="max-w-xl lg:max-w-3xl">
                    ...
                    <form method="post" action="../utils/auth.php" class="mt-8 grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            <span class="ablock text-sm font-medium text-gray-700">
                                Full Name
                            </span>
                            <label for="fullname"
                                class="relative block overflow-hidden bg-white rounded-md border border-gray-200 px-3 pt-3 shadow-sm  focus-within:border-[#243757] focus-within:ring-1 focus-within:ring-[#243757]">
                                <input type="fullname" placeholder="FullName" name="fullname" id="fullname" Required
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <label for="password_confirm"
                                class="relative block overflow-hidden bg-white rounded-md border border-gray-200 px-3 pt-3 shadow-sm focus-within:border-[#243757] focus-within:ring-1 focus-within:ring-[#243757]">
                                <input type="password" placeholder="Password" name="password_confirm" id="password_confirm" Required
                                    class="peer h-8 w-full border-none bg-transparent p-0  placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" />
