...
if ($role_name !== 'karyawan') {
    $reports = query("SELECT reports.*, users.fullname FROM reports JOIN users ON users.id = reports.user_id");
} else {
    $reports = query(
        "SELECT reports.*, users.fullname FROM reports JOIN users ON users.id = reports.user_id WHERE user_id = '$user_id'"
    );
}
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal">Total Reports</p>
                                <h5 class="mb-0 font-bold">
                                    <?php echo $totalReport[0]['total'] ?>
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                <i class="fa-solid fa-file text-lg relative top-3.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal">Total Absent</p>
                                <h5 class="mb-0 font-bold">
                                    0
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                <i class="fa-solid fa-fingerprint text-lg relative top-3.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal">New report</p>
                                <h5 class="mb-0 font-bold">
                                    1
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                <i class="fa-solid fa-file-circle-plus text-lg relative top-3.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal">Acounts</p>
                                <h5 class="mb-0 font-bold">
                                    <?php echo $totalAcount[0]['total'] ?>
                                    <span class="text-sm leading-normal font-weight-bolder text-lime-500">+1</span>
                                </h5>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                <i class="fa-solid fa-user text-lg relative top-3.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                            <div class="flex flex-col h-full">
                                ...
                                <h5 class="font-bold">Fadlan Hidayat</h5>
                        ...
                        <div class="flex flex-wrap mt-0 -mx-3">
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 text-xs font-semibold leading-tight">Reprot</p>
                                </div>
    ...
    <div class="flex flex-wrap my-6 -mx-3">
                        ...
                        <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500" id="pagination-table">
                            ...
                            <tbody>
                                <?php if (empty($reports)) : ?>
                                    <tr>
                                        <td colspan="6" class=" px-6 py-4 text-center text-[#0b1d45]">
                                            Data kosong
                                        </td>
                                    </tr>
                                <?php else :
                                        ...
                                        <tr class=" hover:bg-[#f5f5f5] border-b  text-[#0b1d45]">
                                            ...
                                            <?php if ($role_name !== 'karyawan') : ?>
                                                <td class="px-6 py-4 flex justify-start items-center ">
                                                    ...
                                                    <a href="index.php?page=detail&id=<?= $report['id'] ?>" class="font-medium text-[#0b1d45] hover:underline">
                                                        <svg class="mr-4 w-4 h-4 md:w-5 md:h-5 text-gray-800 dark:text-[#0b1d45]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                                            <path fill-rule="evenodd" d="M4.998 7.78C6.729 6.345 9.198 5 12 5c2.802 0 5.27 1.345 7.002 2.78a12.713 12.713 0 0 1 2.096 2.183c.253.344.465.682.618.997.14.286.284.658.284 1.04s-.145.754-.284 1.04a6.6 6.6 0 0 1-.618.997 12.712 12.712 0 0 1-2.096 2.183C17.271 17.655 14.802 19 12 19c-2.802 0-5.27-1.345-7.002-2.78a12.712 12.712 0 0 1-2.096-2.183 6.6 6.6 0 0 1-.618-.997C2.144 12.754 2 12.382 2 12s.145-.754.284-1.04c.153-.315.365-.653.618-.997A12.714 12.714 0 0 1 4.998 7.78ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clip-rule="evenodd" />
                                                        </svg>
                                                    </a>

                                                    <a href="#" onclick="confirmDelete('reports_delete', 'id',<?= $report['id'] ?>)" class="font-medium text-[#0b1d45] hover:underline">
        ...
        <div class="w-full max-w-full px-3 md:w-1/2 md:flex-none lg:w-1/3 lg:flex-none">
            <div class=" border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                ...
                <div class=" w-8/12 flex-auto p-4">
